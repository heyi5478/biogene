...
- [ ] 8.1 推上分支：`git push -u origin feat/restructure-mockdata-for-api`
- [ ] 8.2 用 `gh pr create` 開 PR，body 引用本 change：`See openspec/changes/restructure-mockdata-for-db-alignment/`
