// spec: specs/export-and-stats.md (Scenario 1.2)
// seed: tests/seed.spec.ts

import { test, expect } from '@playwright/test';

test.describe('Patient Data Export', () => {
  test('JSON export → json file download', async ({ page }) => {
    // 1. Navigate to `/`.
    await page.goto('/');
    ...
    // 3. Open the export dialog from the PatientSummary trigger.
    ...
    // 6–7. Filename assertions; do not read or parse the file body.
