...
export const mockPatients: Patient[] = [
  {
    ...
    mps2: [
      { sampleName: 'MPS-2025-0045', MPS2: 8.5, TPP1: 12.3, MPS4A: 15.8, MPS6: 22.1 },
    ],
    lsd: [
      { sampleName: 'LSD-2025-0078', GAA: 5.2, GLA: 0.8, ABG: 8.5, IDUA: 12.3, ABG_GAA: 1.63 },
    ],
    enzyme: [
      { sampleName: 'ENZ-2025-0112', specimenType: 'Leukocyte', technician: '王小芳', result: 'Deficient', MPS1: 2.1, enzymeMPS2: 45.8 },
    ],
    gag: [
      { sampleName: 'GAG-2025-0056', specimenType: 'Urine', technician: '林美玲', result: 'Elevated', DMGGAG: 185.2, CREATININE: 42.5 },
    ],
    dnabank: [
      { orderno: 'DNA-2025-001', order: 'GLA gene sequencing', orderMemo: 'Fabry suspected', keyword: 'Fabry;GLA', specimenno: 'D-2025-0128', specimen: 'Whole blood' },
    ],
    outbank: [
      { sampleno: 'OUT-2025-0034', shipdate: '2025-11-02', assay: 'GLA gene full sequencing', result: 'c.644A>G (p.N215S) heterozygous' },
    ],
  },
  {
    chartno: 'B2345678',
    ...
    gag: [],
    dnabank: [
      { orderno: 'DNA-2025-008', order: 'PAH gene sequencing', orderMemo: 'PKU confirmed', keyword: 'PKU;PAH', specimenno: 'D-2025-0256', specimen: 'Whole blood' },
    ],
    outbank: [
      { sampleno: 'OUT-2025-0089', shipdate: '2025-10-05', assay: 'PAH gene panel', result: 'c.728G>A (p.R243Q) compound heterozygous' },
    ],
  },
  {
    chartno: 'C3456789',
    ...
    mma: [],
    mps2: [
      { sampleName: 'MPS-2025-0088', MPS2: 1.2, TPP1: 14.5, MPS4A: 18.2, MPS6: 25.6 },
    ],
    lsd: [
      { sampleName: 'LSD-2025-0120', GAA: 6.8, GLA: 4.2, ABG: 9.1, IDUA: 11.8, ABG_GAA: 1.34 },
    ],
    enzyme: [
  ...
  },
  {
    ...
    mps2: [],
    lsd: [
      { sampleName: 'LSD-2025-0155', GAA: 8.2, GLA: 5.5, ABG: 0.3, IDUA: 14.2, ABG_GAA: 0.04 },
    ],
    enzyme: [
      { sampleName: 'ENZ-2025-0201', specimenType: 'Leukocyte', technician: '陳建宏', result: 'Deficient', MPS1: 22.5, enzymeMPS2: 48.2 },
    ],
    gag: [],
    dnabank: [
      { orderno: 'DNA-2025-022', order: 'GBA gene sequencing', orderMemo: 'Gaucher suspected', keyword: 'Gaucher;GBA', specimenno: 'D-2025-0456', specimen: 'Whole blood' },
    ],
    outbank: [
      { sampleno: 'OUT-2025-0178', shipdate: '2025-09-28', assay: 'GBA gene sequencing', result: 'c.1226A>G (p.N409S) homozygous' },
    ],
  },
  {
    chartno: 'E5678901',
    ...
    gag: [],
    dnabank: [
      { orderno: 'DNA-2025-028', order: 'DDC gene sequencing', orderMemo: 'AADC deficiency', keyword: 'AADC;DDC', specimenno: 'D-2025-0512', specimen: 'Whole blood' },
    ],
    outbank: [
      { sampleno: 'OUT-2025-0201', shipdate: '2025-07-10', assay: 'DDC gene analysis', result: 'c.714+4A>T splice site mutation homozygous' },
    ],
  },
];
