...
import { ModuleSection } from '@/components/ResultModules/ModuleSection';
import { MedicalTable } from '@/components/ResultModules/MedicalTable';
import { MonoVal } from '@/components/ResultModules/MonoVal';
