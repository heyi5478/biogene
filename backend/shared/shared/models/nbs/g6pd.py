"""``nbs.g6pd`` — G6PD deficiency screen."""
...
class G6pd(Base, TimestampsMixin, EtlMetaMixin):
    __tablename__ = "g6pd"
    ...
    g6pdActivity: Mapped[Optional[Decimal]] = mapped_column(
        "g6pd_activity", Numeric(10, 3)
    )
